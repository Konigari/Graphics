...
/* Modify the bounds of the screen here in glm::ortho or Field of View in glm::Perspective */
  void project(){
       Matrices.projection = glm::ortho(-(4.0f + panx)*zoom, (4.0f - panx)*zoom, -(4.0f + pany)*zoom, (4.0f - pany)*zoom, 0.1f, 500.0f);
